...
public class VerifyContentContainActionHandle extends ActionHandle {
	private static Logger logger = Logger.getLogger(VerifyContentContainActionHandle.class);
